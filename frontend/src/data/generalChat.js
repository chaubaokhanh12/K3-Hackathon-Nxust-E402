...
export const GENERAL_SEED = [
  ...
  { author: 'Minh Đức', avatarColor: '#7f77dd', time: '10:13', body: 'Chào bạn! Đọc kênh #gioi-thieu trước nhé, có link lấy role theo lớp.' },
  ...
  { author: 'Bảo Trâm', avatarColor: '#fac775', time: '10:24', body: 'Nhóm mình đang làm hướng đó, qua #chia-se xem bài mình mới đăng nhé' },
]
